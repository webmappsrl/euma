...
return new class extends Migration
{
    ...
    public function down()
    {
        Schema::table('members', function (Blueprint $table) {
            ...
            $table->decimal('mountain_trails_construction_cost', 10, 2)->nullable();
            $table->decimal('low_mountain_trails_construction_cost', 10, 2)->nullable();
            $table->decimal('lowland_trails_construction_cost', 10, 2)->nullable();
            $table->boolean('trails_construction_maintained_frequently')->default(false);
            $table->integer('average_trails_construction_maintenance_period')->nullable();
            $table->decimal('mountain_trails_maintenance_cost', 10, 2)->nullable();
            $table->decimal('low_mountain_trails_maintenance_cost', 10, 2)->nullable();
            $table->decimal('lowland_trails_maintenance_cost', 10, 2)->nullable();
            ...
            $table->integer('average_trails_signs_maintenance_period')->nullable();
            $table->text('trails_signs_maintenance_scope')->nullable();
            $table->decimal('average_annual_sign_maintenance_cost_for_mountains')->nullable();
            $table->decimal('average_annual_sign_maintenance_cost_for_low_mountains')->nullable();
            $table->decimal('average_annual_sign_maintenance_cost_for_lowlands')->nullable();
            $table->boolean('trails_maintenance_done_by')->default(false);
