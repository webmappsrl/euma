...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('crag_surveys', function (Blueprint $table) {
            $table->string('respondent_name_and_role', 500)->nullable();
            $table->string('respondent_mail', 500)->nullable();
            $table->string('climbing_frequency', 500)->nullable();
            $table->string('equipping_routes_frequency', 500)->nullable();
            $table->string('managing_rock_climbing_areas_frequency', 500)->nullable();
            $table->string('most_popular_climbing_spot', 500)->nullable();
            $table->string('managing_rock_climbing_areas_description', 500)->nullable();
            $table->string('other_groups_managing_rock_climbing_areas_description', 500)->nullable();
            $table->string('money_source_bolting_infrastructure', 500)->nullable();
            $table->string('legal_responsibility_equippers', 500)->nullable();
            $table->string('rock_climbing_areas_bans', 500)->nullable();
            $table->string('rock_climbing_areas_limitations', 500)->nullable();
            $table->string('limitations_imposing_authority', 500)->nullable();
            $table->string('limitations_efficiency', 500)->nullable();
            $table->string('micro_zoning_examples', 500)->nullable();
            $table->string('disputes_nature_protection', 500)->nullable();
            $table->string('disputes_local_population', 500)->nullable();
            $table->string('disputes_overcrowding', 500)->nullable();
            $table->string('disputes_ownership', 500)->nullable();
            $table->string('disputes_access', 500)->nullable();
            $table->string('disputes_littering', 500)->nullable();
            $table->string('disputes_wild_camping', 500)->nullable();
            $table->string('other_problems', 500)->nullable();
            $table->string('liability_climbing_accidents', 500)->nullable();
            $table->string('good_practice_examples', 500)->nullable();
            $table->string('bad_practice_examples', 500)->nullable();
            $table->string('is_climbing_tourism_country', 500)->nullable();
            $table->string('climbing_destination_season_preferred_regions_countries', 500)->nullable();
            $table->string('regions_with_significant_climbing_tourism_income', 500)->nullable();
            $table->string('crags_developed_with_tourism_funds', 500)->nullable();
            $table->string('experiences_with_climbing_tourists', 500)->nullable();
            $table->string('countries_visited_by_climbers', 500)->nullable();
            $table->string('tourist_associations_promoting_climbing', 500)->nullable();
            $table->string('assessing_climbing_tourism_potential', 500)->nullable();
            $table->string('official_climbing_ethics', 500)->nullable();
            $table->string('obedience_to_climbing_ethics', 500)->nullable();
            $table->string('area_specific_climbing_ethics', 500)->nullable();
            $table->string('bolting_licences_and_manuals', 500)->nullable();
            $table->string('responsibility_for_equipment_failure', 500)->nullable();
            $table->string('potential_for_new_climbing_areas', 500)->nullable();
            $table->string('cooperation_with_climbing_stakeholders', 500)->nullable();
            $table->string('cooperation_with_non_climbing_stakeholders', 500)->nullable();
            $table->string('association_involvement_outdoor_rock_climbing_area', 500)->nullable();
            $table->string('procedure_to_create_new_climbing_areas', 500)->nullable();
            $table->string('statistics_databases_rock_climbing_areas', 500)->nullable();
            $table->string('guidebooks_in_country', 500)->nullable();
            $table->string('other_sources_on_rock_climbing', 500)->nullable();
            $table->string('estimated_people_sport_climbing', 500)->nullable();
            $table->string('estimated_people_climbing_in_gym', 500)->nullable();
            $table->string('estimated_people_bouldering', 500)->nullable();
            $table->string('estimated_people_alpine_climbing', 500)->nullable();
            $table->string('estimated_people_ice_climbing', 500)->nullable();
            $table->string('estimated_people_drytooling', 500)->nullable();
            $table->string('estimated_people_via_ferrata', 500)->nullable();
            $table->string('trends_sport_climbing', 500)->nullable();
            $table->string('trends_gym_climbing', 500)->nullable();
            $table->string('trends_bouldering', 500)->nullable();
            $table->string('trends_alpine_climbing', 500)->nullable();
            $table->string('trends_ice_climbing_dry_tooling', 500)->nullable();
            $table->string('other_climbing_sport_trends', 500)->nullable();
            $table->string('significance_of_trad_aid_climbing', 500)->nullable();
            $table->string('development_of_climbers_in_last_20_years', 500)->nullable();
            $table->string('number_of_climbing_gyms', 500)->nullable();
            $table->string('artificial_climbing_infrastructure_description', 500)->nullable();
            $table->string('association_members_climbers', 500)->nullable();
            $table->string('people_climbing_in_country', 500)->nullable();
            $table->string('is_official_number', 500)->nullable();
            $table->string('number_of_rock_climbing_areas', 500)->nullable();
            $table->string('number_of_bouldering_spots_problems', 500)->nullable();
            $table->string('other_climbing_related_sports', 500)->nullable();
